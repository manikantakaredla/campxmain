...
import ClassSectionAssignmentsTab from './ClassSectionAssignmentsTab'
...
const UploadAssignments = () => {
  ...
  const getConfig = () => {
    if (uploadType === 'class' || uploadType === 'class-bulk') {
      return {
      ...
      <div className="flex gap-2 mb-6 bg-gray-100 p-1 rounded-lg w-fit">
        <button
          ...
          className={`px-4 py-2 rounded-lg font-medium transition-all ${
            uploadType === 'class' || uploadType === 'class-bulk'
        ...
        <div className="flex gap-6 border-b mb-6">
          <button
            ...
            className={`pb-3 font-medium transition-all ${
              uploadType === 'class' ? 'border-b-2 border-blue-600 text-blue-600' : 'border-b-2 border-transparent text-gray-500 hover:text-gray-700'
            }`}
          >
            Assign by Section
          </button>
          <button
            onClick={() => { setUploadType('class-bulk'); setUploadResult(null); setSelectedFile(null) }}
            className={`pb-3 font-medium transition-all ${
              uploadType === 'class-bulk' ? 'border-b-2 border-blue-600 text-blue-600' : 'border-b-2 border-transparent text-gray-500 hover:text-gray-700'
            }`}
          >
            Bulk Upload
          </button>

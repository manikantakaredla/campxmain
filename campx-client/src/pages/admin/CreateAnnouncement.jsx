  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow-sm border p-6">
        <h1 className="text-xl font-bold text-gray-800 mb-2">Create Announcement</h1>
        <p className="text-gray-500 text-sm mb-6">Add a new announcement for students and faculty</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="file" onChange={handleFileChange} accept="image/*,application/pdf" className="w-full" />
            </div>
          </div>

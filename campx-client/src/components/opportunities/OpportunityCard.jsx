  ...
  return (
    <div className="bg-white rounded-3xl md:rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden flex flex-col h-full">
      <div className="p-5 flex-grow">
        <div className="flex justify-between items-start mb-4">
          <div className="flex items-center gap-3">
            {opportunity.companyLogo ? (
              <img src={opportunity.companyLogo} alt={opportunity.companyName} className="w-12 h-12 rounded-lg object-cover border border-gray-100" />
            ) : (
            ...
            <div>
              <h3 className="font-semibold text-gray-900 truncate max-w-[200px]">{opportunity.companyName}</h3>
        ...
        <h4 className="font-bold text-lg text-gray-900 mb-4 line-clamp-2">{opportunity.title}</h4>
      ...
      <div className="border-t border-gray-100 p-4 bg-gray-50 flex justify-between gap-3">
        <button 
          onClick={() => onViewDetails(opportunity)}
          className="flex-1 py-2 px-4 bg-white border border-gray-200 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-colors"
        >
          View Details
        </button>
        <button 
